...
import com.example.android.bakingapp.Adapters.RecyclerIngredientsAdapter;
...
public class IngredientsFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Ingredient>> {
